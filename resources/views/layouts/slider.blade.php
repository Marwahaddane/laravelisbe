                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                        <div class="slider-content slider-animated-1">
                            <h3 class="animated">Nos dernières offres de lancement</h3>
                            <h1 class="animated">Nouvelle collection <br>2024</h1>
                            <div class="slider-btn btn-hover">
                                <a class="animated" href="{{ route('website.produits')}}">Profiter</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
